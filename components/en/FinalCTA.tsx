    ...
    <section id="demo" className="relative overflow-hidden py-40 noise">
      ...
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <h2 className="mt-8 text-5xl font-medium leading-[0.95] md:text-7xl">
          Try AiAsista <br />
          <span className="font-serif italic gradient-text">free for 14 days.</span>
        </h2>
        <p className="mx-auto mt-8 max-w-xl text-lg text-white/60">
          No credit card. No commitment. Setup in 24 hours. If we don&apos;t convince you,
        ...
        <div className="mt-16 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-xs text-white/40">
          <span className="flex items-center gap-2"><span className="h-1 w-1 rounded-full bg-[#6EE7B7]" /> 14 days free</span>
          <span className="flex items-center gap-2"><span className="h-1 w-1 rounded-full bg-[#6EE7B7]" /> Setup in 24h</span>
          <span className="flex items-center gap-2"><span className="h-1 w-1 rounded-full bg-[#6EE7B7]" /> GDPR compliant</span>
          <span className="flex items-center gap-2"><span className="h-1 w-1 rounded-full bg-[#6EE7B7]" /> No commitment</span>
        </div>
      </div>
    </section>
  );
